...
export default function App() {
  ...
  // Extract current screen name for BottomNav
  const currentScreen = location.pathname === '/' ? 'landing' : location.pathname.split('/')[1];
    ...
    <ToastProvider>
      <AuthProvider>
        ...
        <Routes>
          ...
          <Route path="/:id/petDetails" element={<PetDetails onNavigate={handleNavigate} />} />
          <Route path="/details" element={<PetDetails onNavigate={handleNavigate} />} />
